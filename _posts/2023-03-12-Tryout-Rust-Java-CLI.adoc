...
The code consists of a main file. The important the thing is that I use the reqwest and tokio libraries. I am pretty new to Rust code. So don't hesitate to help me improve it.
...
The code consists of a main class. The important the thing is that I use the Jackson library to deserialize my response into a list of UUID.
